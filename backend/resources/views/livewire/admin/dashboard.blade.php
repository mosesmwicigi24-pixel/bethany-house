<div>
        ...
        <div class="bg-white rounded-lg shadow p-6 border-l-4 border-purple-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2">{{ number_format($stats['system_users']) }}</p>
                </div>
            ...
            <div class="mt-4 flex items-center text-sm">
                <span class="text-gray-600">Highest access level</span>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6 border-l-4 border-green-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2">{{ number_format($stats['staff_users']) }}</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow p-6 border-l-4 border-yellow-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2">{{ number_format($stats['customers']) }}</p>
                </div>
            ...
            <div class="mt-4 flex items-center text-sm">
                <span class="text-gray-600">Registered shoppers</span>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="space-y-4">
                @foreach($userTypeStats as $type => $count)
                <div>
                    ...
                    <div class="w-full bg-gray-200 rounded-full h-2">
                        <div class="bg-blue-600 h-2 rounded-full" style="width: {{ $stats['total_users'] > 0 ? ($count / $stats['total_users'] * 100) : 0 }}%"></div>
                    </div>
                </div>
                @endforeach
            </div>
