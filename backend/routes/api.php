...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'throttle:api'])->group(function () {
            ...
            Route::middleware('permission:production.view,sanctum')->group(function () {
                Route::prefix('production-orders')->group(function () {
                    ...
                    Route::put('/{id}/batches',           [ProductionController::class, 'saveBatches'])
                        ->middleware('permission:production.raise_order,sanctum');
                    Route::post('/{id}/batches/{batchId}/images',   [ProductionController::class, 'uploadBatchImage'])
                        ->middleware('permission:production.raise_order,sanctum');
                    Route::delete('/{id}/batches/{batchId}/images', [ProductionController::class, 'deleteBatchImage'])
                        ->middleware('permission:production.raise_order,sanctum');
        ...
        Route::middleware(['role:tailor|admin|super_admin'])->prefix('tailor')->group(function () {
            ...
            // Piece progress: "how many have passed through me?" — assignee action.
            Route::post('/tasks/{id}/progress',   [ProductionController::class, 'updateTaskProgress']);
