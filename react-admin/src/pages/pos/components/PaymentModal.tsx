...
function methodColour(m: ConfiguredMethod) {
    if (m.code === "__other__")                           return { active: "bg-accent-50 border-accent-300 text-accent-800",     dot: "bg-accent-500"   };
    if (m.code === "cash" || m.type === "cash")          return { active: "bg-success-light border-success text-success-dark",  dot: "bg-success"      };
    if (m.code === "mpesa" || m.type === "mobile_money") return { active: "bg-success-50 border-success-400 text-success-800",         dot: "bg-success-500"    };
                    ...
                    <div className="px-4 py-3 space-y-3">
                        ...
                        {(stkStep === "idle" || stkStep === "failed") && (
                            <>
                                ...
                                <p className="text-2xs text-success-700/70">
